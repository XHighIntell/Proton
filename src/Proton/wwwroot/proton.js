...
window.proton = function() {
    ...
    // classes
    proton.EventRegister = function EventRegister(target, option) {
    ...
    // sub-namespace
    proton.winform = function() {
        var winform = proton.winform; winform = {};
        ...
        /** @type defineProperties<typeof proton.winform> */
        var properties = {
            text: {
