...
(function (proton) {
    ...
    var EventRegister = /** @class */ (function () {
        ...
        EventRegister.prototype.dispatch = function () {
            var args = [];
        ...
        EventRegister.prototype.hasListener = function (callback) { return this.listeners.indexOf(callback) != -1; };
        /** Determines whether this event has any listeners. */
        EventRegister.prototype.hasListeners = function () { return this.listeners.length > 0; };
        return EventRegister;
    }());
    proton.EventRegister = EventRegister;
    var postMessagePromiseResolves = {};
    //#region methods
    function generateId() {
        ...
        function init() {
            +function () {
                ...
                window.addEventListener('contextmenu', function (e) {
                    ...
                    var appRegion = getComputedStyle(element)['-webkit-app-region'];
                    if (appRegion !== 'drag')
                        return;
                    // --2--
